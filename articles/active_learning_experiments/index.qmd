---
title: "Evaluating Active Learning Setups for Qualitative Interview Coding"
date: "2026-01-16"
description: "Results from a systematic comparison of active learning setups for qualitative coding."
author-title: Peter Kannewitz
author: '<a href="https://ai-sic.github.io/">aisic</a>'
image: "images/training_time_stacked_sorted_minutes.png"
...
We implemented our experiments using the [small-text](https://small-text.readthedocs.io/en/latest/) active learning framework in Python, which offers a wide range of configuration options.
...
Our experiments focus on sentence transformers, as prior work suggests they outperform the token-based approach in low-data scenarios @setfit. Nevertheless, we included one standard transformer model for comparison. Since each interview segment may receive multiple codes, the task is formulated as a multi-label classification problem.
...
:::{.figure}
![Fig. 1: Macro F1 scores for model settings with a differentiable head.](images/diff_head_models_viridis.png){width=130% fig-align="center"}
:::

:::{.figure}
![Fig. 2: Macro F1 scores for model settings with logistic head.](images/logit_head_models.png){width=130% fig-align="center"}
:::
...
:::{.figure}
![Fig. 3: Class-wise F1 scores for model settings with logistic head and the baseline.](images/logit_classwise_f1_grid.png){width=130% fig-align="center"}
:::
...
:::{.figure}
![Fig. 4: Training time per model configuration.](images/training_time_stacked_sorted_minutes.png){width=130% fig-align="center"}
:::
