...
To allow for later analysis of these effects, we tracked which coder labeled each example. For the experiments reported here, we restricted evaluation to a smaller subset of the test data annotated by a single coder, providing a more stable eference point.
...
:::{.figure}
![Fig. 1: Macro F1 scores for model settings with differentiable head.](images/diff_head_models_viridis.png){width=130% fig-align="center"}
:::
...
:::{.figure}
![Fig. 3: Classwise F1 scores for model settings with logistic head.](images/logit_classwise_f1_grid.png){width=130% fig-align="center"}
:::
